Photographs used on the site (referenced from lib/content.ts):
  ...
  math145.jpg        — CV ▸ Education (last lecture of MATH 145, Galois theory)
  qnc.jpg            — About column (Quantum-Nano Centre)
...
lib/content.ts). Recommended: keep each file under ~1.5 MB so the page stays
